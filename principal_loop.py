...
# graph.add_node("E", "xundas5")
#
# graph.add_edge("1", "A", "B", 1)
# graph.add_edge("2", "B", "C", 2)
# graph.add_edge("3", "C", "D", 3)
# graph.add_edge("4", "D", "A", 4)
# graph.add_edge("5", "C", "E", 5)
# graph.add_edge("6", "D", "E", 6)
...
graph.add_edge("1", "A", "B", 1)
graph.add_edge("2", "A", "C", 1)
graph.add_edge("3", "A", "D", 1)
graph.add_edge("4", "A", "E", 1)
graph.add_edge("5", "B", "C", 1)
graph.add_edge("6", "B", "D", 1)
graph.add_edge("7", "B", "E", 1)
graph.add_edge("8", "C", "D", 1)
graph.add_edge("9", "C", "E", 1)
graph.add_edge("10", "D", "E", 1)
